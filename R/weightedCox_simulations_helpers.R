...
fail_rate <- data.frame(stratum = rep("All", 2 * nrow(fr)),
  ...
  res$mb6z_mine <- cox_rhogamma(dfcount = dfcount, scheme = "MB", scheme_params = list(mb_tstar = 6))$z.score
  #res$mb12z_mine <- cox_rhogamma(dfcount = dfcount, scheme = "MB", scheme_params = list(mb_tstar = 12))$z.score
  res$mb16z_mine <- cox_rhogamma(dfcount = dfcount, scheme = "MB", scheme_params = list(mb_tstar = 16))$z.score
  ...
  temp <- cox_rhogamma(dfcount = dfcount, scheme = "MB", scheme_params = list(mb_tstar = 12), draws = mart_draws)
  ...
  # log-rank
  temp <- cox_rhogamma(dfcount = dfcount, scheme = "fh", scheme_params = list(rho = 0, gamma = 0), draws = mart_draws)
  ...
  temp <- cox_rhogamma(dfcount = dfcount, scheme = "fh_exp1", draws = mart_draws)
  ...
  temp <- cox_rhogamma(dfcount = dfcount, scheme = "fh_exp2", draws = mart_draws)
  ...
  # FH(0,1)
  temp <- cox_rhogamma(dfcount = dfcount, scheme = "fh", scheme_params = list(rho = 0, gamma = 1), draws = mart_draws)
  ...
  # FH(0,0.5)
  temp <- cox_rhogamma(dfcount = dfcount, scheme = "fh", scheme_params = list(rho = 0, gamma = 0.5), draws = mart_draws)
