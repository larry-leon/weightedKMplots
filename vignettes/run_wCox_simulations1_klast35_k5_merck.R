...
# Last n_sim was 35000 (on Linux + mac1):  For seedstart to append to last n_sims
n_last <- 35*1000
seedstart <- 8316951 + 1000*n_last
these_sims <- get_sims(n_sim = 5000, seedstart = seedstart, num_workers = 6, mart_draws = 250, save_results = TRUE,
                       file_togo = "vignettes/results/wCoxsims1_merck_5k.RData"
                       )
