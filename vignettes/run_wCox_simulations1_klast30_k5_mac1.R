...
# Last n_sim was 30000 (on Linux):  For seedstart to append to last n_sims
n_last <- 30*1000
seedstart <- 8316951 + 1000*n_last
these_sims <- get_sims(n_sim = 5*1000, seedstart = seedstart, num_workers = 100, mart_draws = 250, save_results = TRUE, file_togo = "vignettes/results/wCoxsims1_mac_5k.RData")
