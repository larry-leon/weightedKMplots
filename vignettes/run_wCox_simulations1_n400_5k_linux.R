...
these_sims <- get_sims(n_sim = n_now, seedstart = 8316951, num_workers = 100, n_sample = n_sample, mart_draws = 500, save_results = TRUE,
                       file_togo = "vignettes/results/wCoxsims1_linux_n400_5k.RData")
