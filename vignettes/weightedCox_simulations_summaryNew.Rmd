...
load("~/Library/CloudStorage/OneDrive-MerckSharp&DohmeLLC/documents/GitHub/weightedKMplots/vignettes/results/wCoxsims1_linux_25k.RData")
...
# Set label color based on prop_signif > 0.0269
ann_df_ws$label_color <- ifelse(ann_df_ws$prop_signif > 0.0269, "red", "black")
...
z_main <- c('fh00z_mine', 'fh05z_mine', 'fh01z_mine',
            'mb6z_mine', 'mb12z_mine', 'fhe1z', 'fhe2z')
